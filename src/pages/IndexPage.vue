<template>
  <q-page padding>
    <q-header :class="darkModeToggle ? 'bg-grey-10' : 'bg-white'">
      ...
      <q-toolbar :class="darkModeToggle ? 'text-white' : 'text-black'">
        ...
        <q-toolbar-title class="text-bold text-caption text-center">{{ examName.name }}

        </q-toolbar-title>

           <q-btn size="sm"  to="/apps" flat label="More Apps" stack no-caps icon="apps"></q-btn>


        <q-icon @click="darkModeToggle = !darkModeToggle" v-model="darkModeToggle" size="sm"
          :name="darkModeToggle ? 'light_mode' : 'dark_mode'" class="q-ml-sm" />
      ...
      <q-scroll-area class="fit" style="margin-top: 20px;">
        ...
        <div class="q-pa-sm">
          <div class="text-caption text-center">
            ...
            30,000+ Questions <br> <span class="text-bold"> All Exams Covered</span>
          </div>
          <q-item v-if="!premium" class=" q-ma-sm">

            <q-item-section>
              <q-btn to="/upgrade" class=" text-white bgGradient" rounded icon="lock_open" label="Unlimited Access"
          ...
          <q-item style="border-radius: 5px" :active="exam.name == examName.name" class="text-body1"
            ...
            <q-item-section avatar v-if="!premium && (exam.path !== 'fund')">
              <q-btn to="/upgrade" flat size="sm" color="grey-5" icon="lock"></q-btn>
            </q-item-section>



            <q-item-section avatar v-else>
              <q-icon size="xs" color="black" name="lock_open"></q-icon>
            </q-item-section>
    ...
    <!-- <transition v-if="!premium" appear enter-active-class="animated bounceInDown slower delay-2s repeat-2">

      <div v-if="currentQuestion && questionStates">
        <q-banner inline-actions class="text-white bgGradient q-mb-md"
          v-if="currentQuestion['Test Number'] > 5 && !premium" style="border-radius: 12px;">

          <div class="text-body1">Ace Nursing School</div>
          <div class="text-caption">Access 30k+ questions and pass every test.</div>


          <template v-slot:action>
            <q-btn to="/upgrade" flat color="white" icon-right="chevron_right" />
          </template>
</q-banner>
</div>
</transition> -->
  ...
  <q-card flat>
    ...
    <q-card-section class="text-center">
      <div class="text-h5 text-bold">You’re Just Getting Started</div>
      <div class="text-body1 q-mt-sm">
        Go further with unlimited questions, insights, and no distractions.
      </div>
    </q-card-section>
        ...
        <q-list separator>
          <q-item clickable v-ripple>
            <q-item-section avatar>
              <q-icon name="school" color="blue-grey-5" />
            </q-item-section>
          ...
          <q-item clickable v-ripple>
            <q-item-section avatar>
              <q-icon name="block" color="blue-grey-5" />
            </q-item-section>
          ...
          <q-item clickable v-ripple>
            <q-item-section avatar>
              <q-icon name="insights" color="blue-grey-5" />
            </q-item-section>
          ...
          <q-item clickable v-ripple>
            <q-item-section avatar>
              <q-icon name="grade" color="blue-grey-5" />
            </q-item-section>
    ...
    <q-card-section class="text-center" v-if="!premium && currentQuestion['Test Number'] > 11">
      <q-btn
        style="width: 300px;"
        to="/upgrade"
        label="30k Questions - Get Full Access"
        rounded
        class="q-pa-md bgGradient text-white"
        no-caps
      />
    </q-card-section>
    ...
    <!-- <q-card-section class="q-pt-none">
      <div class=" text-center text-bold q-mb-sm">Check Out Our Other Nursing Apps</div>
      <div class=" text-center q-mb-sm"> Practice for every stage of your nursing journey with our companion apps.</div>



      <q-card flat  class="row items-center q-pa-sm q-mb-sm" style="background:#eaf2ff; border-radius: 12px;">
        <q-avatar size="48px" class="q-mr-md">
          <img src="/nclex-rn.png" alt="NCLEX RN App" />
        </q-avatar>
        <div class="col">
          <div class="text-body1 text-weight-bold">NCLEX RN</div>
          <div class="text-caption">1,000+ Questions and Rationales</div>
        </div>
        <q-btn size="sm" label="Get App" color="grey-8" no-caps rounded @click="openLink('https://apps.apple.com/us/app/nclex-rn-test-prep-guide/id6736991589')" />
      </q-card>

        <q-card flat  class="row items-center q-pa-sm q-mb-sm" style="background:#eaf2ff; border-radius: 12px;">
        <q-avatar size="48px" class="q-mr-md">
          <img src="/hesi-a2-complete.png" alt="Hesi A2 Complete Guide" />
        </q-avatar>
        <div class="col">
          <div class="text-body1 text-weight-bold">Hesi A2 Complete</div>
          <div class="text-caption">6000+ Questions and Rationales</div>
        </div>
        <q-btn size="sm" label="Get App" color="grey-8" no-caps rounded @click="openLink('https://apps.apple.com/us/app/a2-nursing-practice-exam-prep/id6499077798')" />
      </q-card>

      <q-card flat  class="row items-center q-pa-sm" style="background:#eaf2ff; border-radius: 12px;">
        <q-avatar size="48px" class="q-mr-md">
          <img src="/nclex-pn.png" alt="NCLEX PN App" />
        </q-avatar>
        <div class="col">
          <div class="text-body1 text-weight-bold">NCLEX PN</div>
          <div class="text-caption">2,800+ practical nursing questions.</div>
        </div>
        <q-btn size="sm" label="Get App" color="grey-8" no-caps rounded @click="openLink('https://apps.apple.com/us/app/nclex-pn-mastery/id6737436836')" />
      </q-card>
    </q-card-section> -->
  </q-card>
</div>
      ...
      <q-footer :class="darkModeToggle ? 'bg-grey-10' : 'bg-white'" class="q-pb-md q-pt-sm q-px-md ">
        ...
        <div class="row justify-between q-pb-md" :class="darkModeToggle ? 'text-white' : 'text-grey-9'">
...
export default {
  ...
  data() {
    return {
      ...
      examName: {
        name: 'fundamentals',
        path: 'src/assets/fundamentals.json',
        url: 'fundamentals'
      },
...
console.log('filename', filename)
  ...
  async created() {
    ...
    // console.log('hasSeenCountDown', hasSeenCountDown)

    // if (!this.premium) {
    //   Notify.create({
    //     message: '📘 Get full access with Pro',

    //     position: 'top',
    //     timeout: 5000, // Show for 3 seconds
    //     actions: [
    //       {
    //         label: 'Upgrade',
    //         color: 'white',
    //         handler: () => {
    //           // Add action to redirect or show the offer
    //           this.$router.push({ name: 'upgrade' })
    //         }
    //       }
    //     ]
    //   });
    //   LocalStorage.setItem('hasSeenCountDown', true); // <- Move this here
    // }
    ...
    const defaultUrlParam = this.urlParam || 'fundamentals';
